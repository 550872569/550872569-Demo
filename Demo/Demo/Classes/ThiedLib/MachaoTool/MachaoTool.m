...
CGSize size = [[NSString stringWithFormat:@"%@",str]boundingRectWithSize:CGSizeMake(VGScreenW * 3 / 5, MAXFLOAT) options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15]} context:nil].size;
UILabel *Label = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, VGScreenW * 3 / 5, size.height)];
...
UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(VGScreenW / 5 - 20, VGScreenH / 4, VGScreenW * 3 / 5 + 40, size.height + 20)];
bgView.backgroundColor = [UIColor whiteColor];
bgView.layer.borderColor = VGColor(230, 230, 230).CGColor;
